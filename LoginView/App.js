...
class RootView extends Component<Props> {
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.BGViewStyle}>
                    ...
                    <View style={[styles.lineStyle, {top: 49.75}]}><Text></Text></View>

                    <View style={[styles.inputCellStyle, {
                        height: 49.75,
                        top: 50.25,
                        right: this.state.PWRight,
                    ...
                    <View style={[styles.lineStyle, {top: 99}]}><Text></Text></View>
                </View>
    ...
    _onClickLogin = () => {
        let usrInfo = "用户名：" + this.state.userName + "密码：" + this.state.userPW;
        Alert.alert(usrInfo);
    };
