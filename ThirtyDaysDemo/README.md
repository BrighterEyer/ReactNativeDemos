...
npm ls gl-react gl-react-native react-native
#参考
#(1)https://github.com/gre/gl-react-native-v2/issues/134
#(2)https://github.com/gre/gl-react/tree/master/packages/gl-react-native#configure-your-react-native-application
npm link gl-react-native
yarn add gl-react@next gl-react-native@next react-native-webgl

#day14，到react-native-swipe-cards模块下更新PropTypes，npm i --save prop-types，注释掉View.propTypes.style
```
